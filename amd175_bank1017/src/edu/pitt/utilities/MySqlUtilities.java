...
public class MySqlUtilities implements DbUtilities{
    ...
    private String dbName = "amd175_bank1017"; // default database name
    private String dbUserName = "amd175"; // login name for the database server
    private String dbPassword = "3674769"; // password for the database server
